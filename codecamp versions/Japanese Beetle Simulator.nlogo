...
to setup
  ...
  set month-count 0 ;;; Month 0 corresponds to January
  set grass-steps 4 ;;; 4 Color steps between new grass and mature grass. Grass color is correlated with grass health
  set mgrass-color 53
  set root-color 47
  set dirt-color brown
  set default-root-health 3
  set blade-growth-step 0.25 ;;; Increment in grass maturity

  set time-days 1 ;;; Starting at day 1 because modulo 0 is undefined
  set day 1
  set tick-delay 0.033 ;;; For 30 fps
  set month item 0 months
  set month-roll True

  set f-beetle-color 121  ;;; female and male beetles are slightly different color
  set m-beetle-color 123
  set beetle-size 3
  set beetle-rotate 30 ;;; Increment of beetle rotation
  set beetle-max-health 40
  set-default-shape beetles "bug"
  set beetle-max-eggs 60;
  set beetle-egg-lay-health 30 ;;; Minimum health at which beetles can lay eggs
  ...
  ask patches[ ;;; populating screen with patches of grass.
...
to go ;;; This function is run once per tick
  ask patches[grow]
  ask turtles[
    season-check
    (ifelse
...
"beetles" 1.0 0 -2674135 true "" "plotxy day count beetles"
